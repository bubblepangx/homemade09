...
// ========================
const IMG = {};
['airplane','character','clock','cloud','creature','flag','flower_1','flower_2','flower_3','lightning','magnet'].forEach(n=>{
...
function loop(){
  ...
  if(gameState==='playing'){
    ...
    flowers.forEach(f  =>spr(stage<=3?'flower_1':stage<=7?'flower_2':'flower_3',f.x,f.y,47,47));
